...
export default function ContactEdit() {
    ...
    async function handleSubmit(e) {
        ...
        if (response.status === 200) {
            await alertSuccess("Data kontak berhasil di ubah");
            await navigate({
    ...
    <div className="flex items-center mb-6">
      ...
      <h1 className="text-2xl font-bold text-white flex items-center">
        <i className="fas fa-user-edit text-blue-400 mr-3"></i> Ubah Kontak
      </h1>
    </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input type="text" id="first_name" name="first_name"
                       ...
                       placeholder="Masukkan nama depan anda" required
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input type="text" id="last_name" name="last_name"
                       className="w-full pl-10 pr-3 py-3 bg-gray-700 bg-opacity-50 border border-gray-600 text-white rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200"
                       placeholder="Masukkan nama belakang anda" required
