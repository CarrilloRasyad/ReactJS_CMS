...
export default function AddressEdit() {
    ...
    async function handleSubmit(e) {
        ...
        if(response.status === 200) {
            await alertSuccess("Data alamat berhasil di ubah");
            await navigate({
    ...
    useEffectOnce(() => {
        fetchContact()
        .then(() => console.log("Berhasil fetched data kontak"));

        fetchAddress()
        .then(() => console.log("Berhasil fetched data alamat"));
    })
    ...
    return <>
      ...
      <h1 className="text-2xl font-bold text-white flex items-center">
        <i className="fas fa-map-marker-alt text-blue-400 mr-3"></i> Ubah Alamat
      </h1>
    </div>
