...
export default function UserProfile() {
    ...
    async function handleSubmitProfile(e) {
        ...
        if (response.status === 200) {
            await alertSuccess("Profil user berhasil di update");
        } else {
    ...
    async function handleSubmitPassword(e) {
        ...
        if(response.status === 200) {
            setPassword('');
            setConfirmPassword('');
            await alertSuccess("Password user berhasil diubah");
        } else {
            await alertError(responseBody.errors);
        }
    }
    ...
    useEffectOnce(() => {
        fetchUserDetail()
        .then(() => console.log("mengambil detail user berhasil"));
    })
          ...
          <form onSubmit={handleSubmitProfile}>
            ...
            <div className="mt-6">
              <button type="submit"
                ...
                <i className="fas fa-save mr-2"></i> Ubah Profile
              </button>
            </div>
          </form>
        </div>
      ...
      <div
        ...
        <div className="p-6">
          ...
          <form onSubmit={handleSubmitPassword}>
            <div className="mb-5">
              <label htmlFor="new_password" className="block text-gray-300 text-sm font-medium mb-2">Password Baru</label>
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
            ...
            <div className="mb-5">
              <label htmlFor="confirm_password" className="block text-gray-300 text-sm font-medium mb-2">Konfirmasi Password Baru</label>
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
